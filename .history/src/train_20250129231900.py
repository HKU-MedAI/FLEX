...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'clam_mb', 'mil', 'dsmil', 'mamba', 'transmil', 'dtfdmil', 's4', 'abmil', 'rrt', 'catemil', 'catemilv2', 'catemil_quilt', 'catemil_plip', 'catemil_pathgenclip', 'ilra', 'wikg', 'acmil'], default='clam_sb', 
