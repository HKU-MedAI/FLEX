...
parser.add_argument('--task', type=str, choices=['BRCA', 'NSCLC', 'STAD', 'BRCA_HER2', 'BRCA_ER', 'BRCA_PR', 'STAD_EBV', 'STAD_MSI', 'BRCA_PIK3CA', 'BRCA_CDH1', 'LUAD_EGFR', 'LUAD_STK11', 'STAD_TP53', 'STAD'])
