...
parser.add_argument('--fold', type=int, default=5,
                    help='number of splits (default: 10)')
parser.add_argument('--task', type=str, choices=['RCC', 'BRAIN', 'camelyon16', 'BRCA', 'NSCLC', 'ESCA_typing', 'SV_COAD', 'SV_ESCA', 'SV_READ', 'SV_STAD', 'BRCA_HER2', 'STAD', 'CRC_MSI', 'PRAD', 'BRACS_MT', 'RCC_sitepre', 'NSCLC_sitepre5', 'CRC_MSI_sitepre5', 'PRAD_sitepre5', 'LUAD_TP53_sitepre5', 'LUAD_TP53_sitepre3_fold3', 'LUAD_TP53_sitepre5_fold3', 'LUAD_STK11_sitepre3_fold5', 'CRC_MSI_sitepre3_fold5', 'CRC_BRAF_sitepre3_fold5', 'CRC_KRAS_sitepre3_fold5', 'CRC_PIK3CA_sitepre3_fold5', 'CRC_TP53_sitepre3_fold5', 'BRCA_sitepre5_fold3', 'BRCA_sitepre4_fold3', 'BRCA_sitepre5_fold3', 'BRCA_noval_sitepre5_fold3', 'BRCA_TP53_sitepre5_fold3', 'BRCA_TP53_sitepre3_fold5', 'LUAD_TP53_sitepre3_fold5', 'LUAD_EGFR_sitepre5_fold3', 'LUAD_EGFR_sitepre3_fold5', 'LUAD_KRAS_sitepre5_fold3', 'LUAD_KRAS_sitepre3_fold5', 'LUAD_SPTA1_sitepre3_fold5', 'LUAD_TTN_sitepre3_fold5', 'LUAD_NTRK1_sitepre3_fold5', 'NSCLC_sitepre5_fold3', 'STAD_MSI_sitepre3_fold5', 'STAD_EBV_sitepre3_fold5', 'STAD_LAUREN_sitepre3_fold5', 'STAD_LAUREN_sitepre3_fold5_2', 'STAD_TP53_sitepre3_fold5', 'STAD_MUC16_sitepre3_fold5', 'STAD_MSTATUS_sitepre3_fold5', 'STAD_NSTATUS_sitepre3_fold5', 'BRCA_HER2_sitepre5_fold3', 'BRCA_ER_sitepre5_fold3', 'BRCA_PR_sitepre5_fold3', 'BRCA_PIK3CA_sitepre5_fold3', 'BRCA_PIK3CA_sitepre3_fold5', 'BRCA_CDH1_sitepre5_fold3', 'BRCA_CDH1_sitepre3_fold5', 'BRCA_EGFR_sitepre3_fold5', 'BRCA_BRCA1_sitepre3_fold5', 'BRCA_BRCA2_sitepre3_fold5', 'BRCA_ESR1_sitepre5_fold3', 'BRCA_GATA3_sitepre5_fold3', 'SARC_sitepre2_fold5', 'GBM_IDH1_sitepre3_fold5', 'LGG_IDH1_sitepre3_fold5', 'LGG_IDH1_sitepre5_fold3'], default='STAD_MUC16_sitepre3_fold5')
...
# parser.add_argument('--sites', type=list, default=[1],)
...
if __name__ == '__main__':
    ...
    # in_domain_site = ['A2', 'E2']

    # split_dir = '10fold_splits/'+ str(args.task) + '_{}'.format(int(label_fracs * 100))
    split_dir = 'site_splits/'+ str(args.task)
    # split_dir = 'site_splits/'+ str(args.task) + f'_{args.sites[0]}_{args.sites[1]}'
    # split_dir = 'site_splits/'+ str(args.task) + f'_{args.sites[0]}_{args.sites[1]}_{args.sites[2]}'
    # split_dir = 'site_splits/'+ str(args.task) + f'_{args.sites[0]}_{args.sites[1]}_{args.sites[2]}_{args.sites[3]}'
    # split_dir = 'site_splits/'+ str(args.task) + f'_{args.sites[0]}_{args.sites[1]}_{args.sites[2]}_{args.sites[3]}_{args.sites[4]}_{args.sites[5]}'
    ...
    for i in range(args.k):
        ...
        for j in range(args.fold):
            ...
            # save_splits(splits, ['train', 'test'], os.path.join(split_dir, 'splits_{}.csv'.format(i * args.fold + j)), out_test=out_domain_test_ids)
            # save_splits(splits, ['train', 'test'], os.path.join(split_dir, 'splits_{}_bool.csv'.format(i * args.fold + j)), boolean_style=True)
    ...
    #     os.makedirs(split_dir, exist_ok=True)
    #     # import ipdb; ipdb.set_trace()
    #     sorted_slide_data = dataset.slide_data.sort_values(by='case_id').reset_index(drop=True)
    #     # custom_test_ids = sorted_slide_data.index[sorted_slide_data['case_id'].str.contains('test')].tolist()
    #     # dataset.create_splits(k = args.k, val_num = val_num, test_num = test_num, label_frac=lf, custom_test_ids=custom_test_ids)
    #     dataset.create_splits(k = args.k, val_num = val_num, test_num = test_num, label_frac=label_fracs)
    #     for i in range(args.k):
    #         dataset.set_splits()
    #         descriptor_df = dataset.test_split_gen(return_descriptor=True)
    #         splits = dataset.return_splits(from_id=True)
    ...
    # else:
    #     label_fracs = label_num / (num_slides_cls.sum() * 0.8)
    #     # label_num = 0
    #     split_dir = '10fold_splits/'+ str(args.task) + '_rn{}'.format(int(label_num))
    #     os.makedirs(split_dir, exist_ok=True)
    #     # import ipdb; ipdb.set_trace()
    #     # sorted_slide_data = dataset.slide_data.sort_values(by='case_id').reset_index(drop=True)
    #     dataset.create_splits(k = args.k, val_num = val_num, test_num = test_num, label_frac=label_fracs, label_num=0)
    #     for i in range(args.k):
    #         dataset.set_splits()
    #         descriptor_df = dataset.test_split_gen(return_descriptor=True)
    #         splits = dataset.return_splits(from_id=True)
