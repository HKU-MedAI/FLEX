...
parser.add_argument('--model_type', type=str, choices=['hipt_lgp', 'hipt_n', 'hit', 'clam_sb', 'clam_mb', 'mil', 'dsmil', 'mamba', 'transmil', 'dtfdmil', 's4', 'abmil', 'rrt', 'catemil', 'catemilv2', 'catemil_quilt', 'catemil_plip', 'catemil_pathgenclip', 'ilra', 'wikg', 'acmil'], default='clam_sb', 
                    help='type of model (default: clam_sb, clam w/ single attention branch)')
parser.add_argument('--exp_code', type=str, help='experiment code for saving results')
parser.add_argument('--weighted_sample', action='store_true', default=False, help='enable weighted sampling')
parser.add_argument('--model_size', type=str, choices=['small', 'big'], default='small', help='size of model, does not affect mil')
parser.add_argument('--task', type=str, choices=['BRCA', 'NSCLC', 'STAD', 'BRCA_HER2', 'BRCA_ER', 'BRCA_PR', 'STAD_EBV', 'STAD_MSI', 'BRCA_PIK3CA', 'CRC_MSI', 'CRC_BRAF', 'CRC_KRAS', 'CRC_PIK3CA', 'CRC_TP53', 'ESCA', 'PRAD', 'BRACS_MT', 'NSCLC_clasite', 'LUAD_TP53', 'LUAD_STK11', 'BRCA_TP53', 'BRCA_PIK3CA', 'BRCA_CDH1', 'BRCA_EGFR', 'BRCA_BRCA1', 'BRCA_BRCA2', 'BRCA_ESR1', 'BRCA_GATA3', 'STAD_LAUREN', 'STAD_TP53', 'STAD_MUC16', 'STAD_MSTATUS', 'STAD_NSTATUS', 'LUAD_EGFR', 'LUAD_KRAS', 'LUAD_SPTA1', 'LUAD_TTN', 'LUAD_NTRK1', 'SARC', 'GBM_IDH1', 'LGG_IDH1'])
