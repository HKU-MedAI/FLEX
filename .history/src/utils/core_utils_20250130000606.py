...
def train(datasets, cur, args):
    ...
    for epoch in range(args.max_epochs):
        ...
        if  pretrain_epoch != 0 and epoch < pretrain_epoch:
            print('Pretraining ...')
            train_loop_flex(epoch, model, train_loader, optimizer, args.n_classes, args.bag_weight, writer, loss_fn, model_type=args.model_type, pretrain=True, base_mil=args.base_mil, args=args)
            stop = False
            ...
            train_loop_flex(epoch, model, train_loader, optimizer, args.n_classes, args.bag_weight, writer, loss_fn, model_type=args.model_type, pretrain=False, base_mil=args.base_mil, args=args)
