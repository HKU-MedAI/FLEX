...
def train(datasets, cur, args):
    ...
    for epoch in range(args.max_epochs):
        ...
        if args.model_type in ['hit', 'dsmil', 'hipt_lgp', 'hipt_n', 'mamba', 'transmil', 'dtfdmil', 's4', 'abmil', 'rrt', 'catemil', 'catemilv2', 'catemil_quilt', 'catemil_plip', 'catemil_pathgenclip', 'ilra', 'wikg', 'acmil'] and not args.no_inst_cluster:
