...
def train(datasets, cur, args):
    ...
    if args.model_type == 'flex':
        model = FLEX(n_classes=args.n_classes, task=args.task, fold=cur, exp_code=args.exp_code, n_ctx=args.len_learnable_prompt, base_mil=args.base_mil, slide_align=args.slide_align)
    else:
