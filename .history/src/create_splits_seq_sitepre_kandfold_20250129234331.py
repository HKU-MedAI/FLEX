...
parser.add_argument('--fold', type=int, default=5,
                    help='number of splits (default: 10)')
parser.add_argument('--task', type=str, choices=['BRCA', 'NSCLC', 'STAD_LAUREN', 'BRCA_HER2', 'BRCA_ER', 'BRCA_PR', 'STAD_EBV', 'STAD_MSI', 'BRCA_PIK3CA', 'BRCA_CDH1', 'LUAD_EGFR', 'LUAD_STK11', 'STAD_TP53', 'STAD_MUC16', 'CRC_BRAF', 'CRC_TP53'], default='STAD_MUC16_sitepre3_fold5')
